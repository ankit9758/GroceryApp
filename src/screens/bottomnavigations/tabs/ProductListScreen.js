...
import {
    ...
    SafeAreaView, StatusBar, Image, StyleSheet, ActivityIndicator, RefreshControl, Keyboard, Dimensions
} from "react-native"
...
import { image_wishlist, image_add_wishlist } from '../../../../utils/images';
        ...
        <View style={styles.container}>
            {loading ? (<View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ flexDirection: 'column' }}>
                    <AppButton title={'All Checked '} onPress={() => {
                    const abc=[]
                     products.map((data)=>{
                        data.isOnWishlist=!data.isOnWishlist
                        abc.push(data)
                     })
                     //setProducts([...products,!products.isOnWishlist])
                     setProducts(abc)
                    }} />
                    <FlatList
