...
import { image_city, image_pincode, image_state, image_back, image_edit, image_delete } from "../../utils/images";
                    ...
                    return (
                        <View style={styles.addressItems}>
                            ...
                            <Text style={[styles.stateText, {
                                ...
                                backgroundColor: red, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10
                            }]}>{item.type}</Text>
                            <View style={styles.addressActions}>
                                <TouchableOpacity onPress={()=>{
                                      navigation.navigate('AddAddress',{types:'edit',data:item})
                                }}>
                                    <Image style={styles.imgStyle} source={image_edit} />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => {
                                    setId(item.id)
                                    setVisible(true)
